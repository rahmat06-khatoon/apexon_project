...
public class ProductDTO {
	...
	public String toString() {
		return "ProductDTO [id=" + id + ", name=" + name + ", categoryId=" + categoryId + ", price=" + price
				+ ", weight=" + weight + ", description=" + description + ", imageName=" + imageName + ", getId()="
				+ getId() + ", getName()=" + getName() + ", getCategoryId()=" + getCategoryId() + ", getPrice()="
				+ getPrice() + ", getWeight()=" + getWeight() + ", getDescription()=" + getDescription() + "]";
	}
